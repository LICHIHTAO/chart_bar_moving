...
/***/ "./src/graph/distribution/data.ts":
/*!****************************************!*\
  !*** ./src/graph/distribution/data.ts ***!
  \****************************************/
...
/*!************************************************!*\
  !*** ./src/graph/distribution/distribution.ts ***!
  \************************************************/
...
class chart {
    ...
    inputData(data) {
        let arr = [];
        (0, d3_array_1.map)(data, d => arr.push(d.age));
        let ageslist = [...new Set(arr)];
        arr = [];
        (0, d3_array_1.map)(data, d => arr.push(d.submajor));
        let majorlist = [...new Set(arr)];
        let stack1 = (0, d3_shape_1.stack)().keys(ageslist).order(d3_shape_1.stackOrderNone)
            .offset(d3_shape_1.stackOffsetNone)(data);
        console.log(stack1);
...
chart1.inputData(data_1.data1);

})();

/******/ })()
;
//# sourceMappingURL=d3Distribution.js.map