...
class chart {
    constructor() {
        ...
        this.xDomain = (0, d3_array_1.range)(this.xmax());
        this.xScale = (0, d3_scale_1.scaleBand)().domain(this.xDomain).range(this.xRange).paddingInner(this.paddinginner).paddingOuter(this.paddingouter);
        this.xAxis = (0, d3_axis_1.axisBottom)(this.xScale).tickSizeOuter(0);
    ...
    select(tagName) {
        ...
        const svg = (0, d3_selection_1.select)(tagName)
            .append("svg")
    ...
    down(svg, d) {
        if (!d.children || (0, d3_transition_1.active)(svg.node()))
            return;
        ...
        move.selectAll("rect")
            .attr("fill-opacity", 1)
            .transition().duration(this.duration)
            .attr("transform", (d, i) => this.transforming(d, i, "spread"));
        const enter = this.fullcolorBar(svg, d, ".d3Chart_stats_exit");
        const ymax = (0, d3_array_1.max)(d.children, d => d ? d.value : 0);
        ...
        svg.select(".d3Chart_stats_x-axis")
            .selectAll("text")
            .text(null)
            .data((0, d3_array_1.map)(d.children, d => d.data.name))
            .text(d => d)
            .attr("opacity", 0)
        ...
        enter.transition().duration(this.duration).transition()
            .on("start", function (p) { (0, d3_selection_1.select)(this).attr("fill-opacity", 1); });
        enter.selectAll("g")
            .transition().duration(this.duration).transition()
            .attr("transform", (d, i) => this.transforming(d, i, "array"));
    ...
    up(svg, d) {
        ...
        const exit = svg.selectAll(".d3Chart_stats_enter")
            .attr("class", "d3Chart_stats_exit");
        const ymax = (0, d3_array_1.max)(d.parent.children, d => d ? d.value : 0);
        this.yScale.domain([0, ymax ? ymax : 0]);
        const y = svg.select(".d3Chart_stats_y-axis");
        y.transition().duration(this.duration)
            ...
            .call(g => g.selection ? g.selection().select(".domain").remove() : g.select(".domain").remove());
        exit.transition().duration(this.duration)
            .on("end", function (p) { (0, d3_selection_1.select)(this).remove(); })
            .call(g => g.selectAll("g").attr("transform", (d, i) => this.transforming(d, i, "up")))
            .call(g => g.selectAll("g")
            .selectAll('rect')
            .attr("height", (d) => {
            const data = d;
        ...
        svg.select(".d3Chart_stats_x-axis")
            .selectAll("text")
            .text(null)
            .data((0, d3_array_1.map)(d.parent.children, d => d.data.name))
            .text(d => d)
            .attr("opacity", 0)
            .attr("transform", `rotate(60)`)
            .transition().duration(this.duration).transition()
        ...
        move.selectAll("rect")
            ...
            .on("start", function (p) { (0, d3_selection_1.select)(this).attr("fill-opacity", 1); });
        move.transition().duration(this.duration).transition().on("end", function (p) { (0, d3_selection_1.select)(this).remove(); });
    ...
    fullcolorBar(svg, d, selector) {
        ...
        g.attr("fill-opacity", 0)
            ...
            .attr("width", this.xScale.bandwidth())
            .append("title")
            .text(d => { var _a; return [d.data.name, (_a = (d.data.value)) === null || _a === void 0 ? void 0 : _a.toLocaleString('en-US')].join("\n"); });
        return g;
    }
    ...
    alphaData(data) {
        ...
        const data1 = (0, d3_hierarchy_1.hierarchy)(data)
            ...
            if (a.value == undefined || b.value == undefined) {
                ...
                return (0, d3_array_1.ascending)(a.data.name, b.data.name);
            }
        })
            .eachAfter((d) => {
            if (d.parent) {
    ...
    inputData(data) {
        ...
        const data1 = (0, d3_hierarchy_1.hierarchy)(data)
            ...
            if (a.value == undefined || b.value == undefined) {
                ...
                return (0, d3_array_1.ascending)(b.value, a.value);
            }
        })
            .eachAfter((d) => {
            if (d.parent) {
...
/******/ })()
;
//# sourceMappingURL=d3Classtest.js.map